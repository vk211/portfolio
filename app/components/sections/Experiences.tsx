...
export default function Experiences({
  ...
  return (
    <section
      id={sectionId}
      className="flex flex-col justify-center items-center min-h-screen font-mono px-4 sm:px-8 md:px-16 bg-gradient-to-b to-green-50 from-yellow-50 text-gray-900"
    >
